...
$arTemplateParameters["LIST_PREVIEW_PICT_H"] = array(
	"NAME" => GetMessage("LIST_PREVIEW_PICT_H"),
	"TYPE" => "STRING",
	"DEFAULT" => "150",
);
$arTemplateParameters["LIST_PREVIEW_PICT_W"] = array(
	"NAME" => GetMessage("LIST_PREVIEW_PICT_W"),
	"TYPE" => "STRING",
	"DEFAULT" => "250",
);
$arTemplateParameters["LIST_DETAIL_PICT_H"] = array(
	"NAME" => GetMessage("LIST_DETAIL_PICT_H"),
	"TYPE" => "STRING",
	"DEFAULT" => "450",
);
$arTemplateParameters["LIST_DETAIL_PICT_W"] = array(
	"NAME" => GetMessage("LIST_DETAIL_PICT_W"),
	"TYPE" => "STRING",
	"DEFAULT" => "550",
);
